...
const getPostImage = (post: PartialPost): { resource?: any; src?: string } | null => {
...
export const CategoryPostsLayout: React.FC<CategoryPostsLayoutProps> = ({ posts }) => {
  const getCategoryTitle = (post: PartialPost): string => {
  ...
  return (
    <div className="container">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Featured Posts - Right Column (2/3) */}
        <div
            ...
            {featuredPosts[0] && (
              <div className="relative group">
                <div className="relative aspect-[16/9] overflow-hidden rounded-lg">
                  {(() => {
                    const img = getPostImage(featuredPosts[0])
                    if (!img) {
                      return (
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-xs font-semibold uppercase tracking-wide text-white">
                              {getCategoryTitle(featuredPosts[0])}
                            </span>
                          </div>
